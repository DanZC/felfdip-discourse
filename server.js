...
app.get('/',function(req,res){
    res.sendFile(__dirname+'/FelfdipDiscourse.html');
});
...
class MatchState {
    ...
    newTurn() {
        for(var i in this.a.members) {
            var c = this.a.members[i].get_card();
            if(c !== null) c.resetAttacks();
        }
        for(var i in this.b.members) {
            var c = this.b.members[i].get_card();
            if(c !== null) c.resetAttacks();
        }
    }
